...
namespace TickAPI.Migrations
{
    ...
    [Migration("20250514235701_MadeNameOnTicketUnnecessary")]
    partial class MadeNameOnTicketUnnecessary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TickAPI.Categories.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ec3daf69-baa9-4fcd-a674-c09884a57272"),
                            Name = "Music"
                        },
                        new
                        {
                            Id = new Guid("de89dd76-3b29-43e1-8f4b-5278b1b8bde2"),
                            Name = "Sports"
                        },
                        new
                        {
                            Id = new Guid("ea58370b-2a17-4770-abea-66399ad69fb8"),
                            Name = "Conferences"
                        },
                        new
                        {
                            Id = new Guid("4a086d9e-59de-4fd1-a1b2-bd9b5eec797c"),
                            Name = "Theatre"
                        },
                        new
                        {
                            Id = new Guid("5f8dbe65-30be-453f-8f22-191a11b2977b"),
                            Name = "Comedy"
                        },
                        new
                        {
                            Id = new Guid("4421327a-4bc8-4706-bec0-666f78ed0c69"),
                            Name = "Workshops"
                        });
                });
            ...
            modelBuilder.Entity("TickAPI.Events.Models.Event", b =>
                {
                    b.HasOne("TickAPI.Addresses.Models.Address", "Address")
                        .WithMany()
